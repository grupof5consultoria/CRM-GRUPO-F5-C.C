...
function getOnboardingTemplate(): StepTemplate[] {
  return [
    {
      num: 1,
      title: "Enviar mensagem para coletar dados de contrato e cobrança",
      checklist: [
        { id: "cnpj",          label: "[Dados da Empresa] CNPJ da empresa",                checked: false },
        { id: "endereco_emp",  label: "[Dados da Empresa] Endereço da empresa",             checked: false },
        { id: "socio_nome",    label: "[Sócio ADM] Nome completo",                          checked: false },
        { id: "socio_end",     label: "[Sócio ADM] Endereço completo com CEP",              checked: false },
        { id: "socio_cpf",     label: "[Sócio ADM] CPF",                                   checked: false },
        { id: "socio_email",   label: "[Sócio ADM] Email",                                 checked: false },
        { id: "resp_nome",     label: "[Resp. Financeiro] Nome completo",                   checked: false },
        { id: "resp_tel",      label: "[Resp. Financeiro] Telefone WhatsApp com DDD",       checked: false },
        { id: "resp_email",    label: "[Resp. Financeiro] Email",                           checked: false },
      ],
    },
    {
      num: 2,
      ...
      checklist: [
        { id: "contrato_enviado", label: "Contrato enviado por email", checked: false },
      ],
    },
    {
      num: 3,
    ...
    {
      num: 5,
      title: "Avisar o cliente sobre cobrança e contrato — msg para a Dona da empresa",
      checklist: [],
    },
    {
      num: 6,
    ...
    {
      num: 8,
      title: "Criar doc com nome do cliente — reuniões",
      checklist: [],
    },
    {
      num: 9,
    ...
    },
    {
      ...
      checklist: [
        ...
        { id: "regras",       label: "Verificar regras personalizadas na conta — se houver, excluir todas",                 checked: false },
    ...
    {
      num: 13,
      title: "Incluir cliente no Reportei",
      checklist: [],
    },
    {
      num: 14,
    ...
    {
      num: 15,
      title: "Reunião de apresentação das estratégias / data",
      checklist: [
    ...
    {
      num: 16,
      title: "Criar task modelo do cliente no ClickUp",
      checklist: [],
    },
    {
      num: 17,
