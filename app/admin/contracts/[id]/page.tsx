          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {renderedText ? (
              <div className="bg-[#111] rounded-2xl border border-[#1e1e1e] overflow-hidden">
                <div className="px-5 py-3 border-b border-[#1e1e1e] flex items-center justify-between gap-2">
                  ...
                  <Link href={`/admin/contracts/${contract.id}/print`} target="_blank">
                    <button className="flex items-center gap-1.5 text-xs bg-violet-600/15 hover:bg-violet-600/25 border border-violet-600/30 hover:border-violet-500/50 text-violet-400 hover:text-violet-300 rounded-lg px-3 py-1.5 transition-all">
