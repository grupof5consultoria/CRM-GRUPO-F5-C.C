...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .print-bar { position: fixed; top: 0; left: 0; right: 0; background: #0f172a; padding: 10px 20px; display: flex; align-items: center; justify-content: space-between; z-index: 100; box-shadow: 0 2px 8px rgba(0,0,0,0.3); }
    .print-bar-title { color: #94a3b8; font-family: sans-serif; font-size: 13px; }
    ...
    .back-btn { background: rgba(255,255,255,0.08); color: #94a3b8; border: 1px solid rgba(255,255,255,0.15); padding: 8px 14px; border-radius: 8px; font-size: 13px; font-family: sans-serif; cursor: pointer; }
...
<body>
  <div class="print-bar">
    ...
    <span class="print-bar-title">Grupo F5 — Contrato de Prestação de Serviços</span>
  ...
  <div class="page">
    ...
    <div class="status-banner">
      ...
      Assinado por: <strong>${contract.signedByName}</strong> (CPF: ${contract.signedByCpf})<br>
      Data/Hora: ${signedDateStr}
    </div>` : ""}

    <pre class="contract-body">${contractText.replace(/</g, "&lt;").replace(/>/g, "&gt;")}</pre>
    ...
    <div class="signature-section">
      <div class="signature-grid">
        ...
        <div>
          ...
          <div class="sig-name">${isSigned ? contract.signedByName : vars.nomeContratante}</div>
          <div class="sig-detail">CPF: ${isSigned ? contract.signedByCpf : vars.cpfContratante}</div>
