...
export function PortalSidebar({ userName, logoutAction }: PortalSidebarProps) {
  ...
  return (
    <aside className="flex flex-col w-60 bg-slate-800 min-h-screen">
      <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-700">
        ...
        <div>
          <span className="text-white font-semibold text-sm block">Portal</span>
          <span className="text-slate-400 text-xs">Área do Cliente</span>
        </div>
      </div>
